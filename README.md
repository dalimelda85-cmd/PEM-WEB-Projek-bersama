...
BUG 1: Tidak ada validasi jenis kelamin Jika user tidak memilih JK, program tetap berjalan dan mengisi "-"
...
BUG 2 : password tidak wajib diisi
...
#
BUG 3: Validasi jenis kelamin tidak ada Jika tidak dipilih, tetap lanjut dengan nilai "-"
...
#
        row.innerHTML = `
            ...
            <td>${ttl}</td>
#
BUG 4: Password ditampilkan langsung di tabel Ini tidak aman karena password adalah data sensitif
...
#
BUG 5: Ikon tidak muncul jika file tidak ada Solusi: gunakan emoji atau CDN

        <a href="#" onclick="deleteRow(this)">
            <img src="trash.png" width="20">
            </a>
#
BUG 6: href="#" bisa menyebabkan halaman loncat ke atas
...
#
BUG 9: Edit tidak lengkap Jenis kelamin dan TTL tidak dikembalikan ke form
